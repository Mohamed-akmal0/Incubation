  ...
  const generateError = (err) => toast.error(err,{
    ...
    const onSubmit = async (data) => {
        ...
        const Data = {
            ...
            state: data.state,
            email: data.email,
            Describe_Your_Company_And_Products: data.company_and_products,
        ...
        Axios.post('/user/application' , Data).then((response) =>{
        ...
        <div className="form">
            ...
            <div className="col-md-6 mt-md-0 mt-3">
                ...
                {errors.address?.type === "minLength" && (
                    <span>address must be minimum 4 Character</span>
                )}
            ...
            <div className="col-md-6 mt-md-0 mt-3">
                ...
                {errors.city?.type === "minLength" && (
                    <span>city must be minimum 4 Character</span>
                )}
            ...
            <div className="col-md-6 mt-md-0 mt-3">
                ...
                {errors.state?.type === "minLength" && (
                    <span>state must be minimum 4 Character</span>
                )}
            ...
            <div className="col-md-6 mt-md-0 mt-3">
                ...
                {errors.company_name?.type === "minLength" && (
                    <span>
                    this field must be minimum 4 Character
                    </span>
                )}
            ...
            <span className="text-danger">
                ...
                <span>this field must be minimum 4 Character</span>
                )}
